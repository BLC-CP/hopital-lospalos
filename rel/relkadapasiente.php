...
<div id="div1">
	...
	<table width="100%" border="1">
		...
		<tbody>
			...
			$a=$conn->query("select * FROM tb_pasiente where id_pasiente like '$id_pasiente' LIMIT 1");
			while($r=$a->fetch_array()){
				...
				<tr>
					...
					<td>
						Dadus husi <b><?php echo $r['nrn_pasiente']; ?></b> nian.
					</td>
	...
	<table width="100%" border="1">
		...
		<tbody>
			...
			$a=$conn->query("select * FROM tb_registu_pasiente, tb_doutor, tb_tipu_pasiente, tb_pasiente, tb_moras, tb_klasifikasaun WHERE 
				...
				tb_pasiente.id_pasiente like '$id_pasiente'
				");
			while($r=$a->fetch_array()){
				?>
